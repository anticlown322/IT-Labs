object frmMain: TfrmMain
  ...
  object pNav: TPanel
    ...
    TabOrder = 0
    OnMouseDown = Dragging
    object spdbtnLFSR: TSpeedButton
      Tag = 1
  ...
  object pgcSections: TPageControl
    ...
    object tsLFSR: TTabSheet
      ...
      object shpStartRegister: TShape
        AlignWithMargins = True
        Left = 10
        Top = 89
        Width = 614
      ...
      object pOptions: TPanel
        ...
        ShowCaption = False
        TabOrder = 2
        object spdbtnLoadFile: TSpeedButton
          Tag = 1
          Left = 180
          Top = 0
          Width = 140
        ...
        object spdbtnEncode: TSpeedButton
          Tag = 2
          Left = 40
          Top = 0
          Width = 140
  ...
  object actmngActions: TActionManager
    ...
    object actUseAlg: TAction
      Category = 'Ciphering'
      OnExecute = actUseAlgExecute
    end
