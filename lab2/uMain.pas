...
Type
    ...
    Private
        Engine: TCipherEng;
        FileData, Answer, Key: TArray<Byte>;
        //
    ...
    Begin
        ...
        Try
            ...
            Try
                ...
                LbInputData.Caption := 'Исходник: ' + DlgLoadFile.FileName;
            Except
...
Begin
    ...
    Begin
        Try
            TFile.WriteAllBytes(DlgSaveFile.FileName, Answer);
        Except
...
Begin
    ...
    Begin
        ...
        Answer := Engine.TranslateBINDataToBytes(Engine.BinResult);
        Key := Engine.TranslateBINDataToBytes(Engine.BinKey);
        MmGeneratedKey.Text := BytesToStr(Key);
        MmOutput.Text := BytesToStr(Answer);
        SpdbtnSaveFile.Enabled := True;
    End
    Else
